...
import mqtt.mapping.connector.mqtt.MQTTCallback;
...
@Slf4j
public class MQTTConnectClient implements IConnectorClient{

    public MQTTConnectClient(MicroserviceCredentials credentials, String tenantId, MappingComponent mappingComponent, ConnectorConfigurationComponent connectorConfigurationComponent, C8YAgent c8YAgent, ExecutorService cachedThreadPool, ObjectMapper objectMapper, String additionalSubscriptionIdTest, String baseUrl, Platform platformAPI) {
        setConfigProperties();
    ...
    public void initialize(String tenant) {
        ...
        this.client = MqttClient.webSocket()
                .url(baseUrl)
                .tokenApi(platformAPI.getTokenApi())
                .build();
    }
